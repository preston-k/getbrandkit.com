...
invokeSerial = function(tasks, opts, cb) {
  ...
  serial = function(cb) {
    ...
    next = function(err) {
      ...
      if (tasks.length) {
        return invoke$3(tasks.shift(), opts, next);
      } else {
        return cb();
      }
    };
...
invoke$2 = function(name, opts, cb) {
...
invokeParallel = function(tasks, opts, cb) {
  ...
  parallel = function(cb) {
    ...
    for (i = 0, len = tasks.length; i < len; i++) {
      task = tasks[i];
      results.push(invoke$3(task, opts, function() {
...
var invoke$1 = wrapper;

// src/option.coffee
var option = function(letter, flag, description) {};
...
// src/watch.coffee
var watch = function(dir, task, opts) {
  var fn;
  if (opts == null) {
    opts = {};
  }
